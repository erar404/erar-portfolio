...
export function Ticker() {
  ...
  return (
    <div className="relative overflow-hidden border-y border-line bg-bg-sunken/60 py-3.5" aria-label="Technologies I work with">
      ...
      <ul className="flex w-max animate-ticker gap-8 whitespace-nowrap font-mono text-[0.72rem] uppercase tracking-[0.14em] text-ink-muted motion-reduce:animate-none">
        {loop.map((t, i) => (
